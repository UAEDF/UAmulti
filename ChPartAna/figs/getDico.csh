...
##########################################################
#
#     To use in plugin dir
#     Gets all plugins/classes, and writes
#	the linkdef.c/h
#
#
##########################################################
...
echo "#pragma link C++ class vector<TMean>+;">>LinkDef.h
...
echo "#pragma link C++ class TPlotterBase+;">>LinkDef.h
echo "#pragma link C++ class TPlotter+;">>LinkDef.h
