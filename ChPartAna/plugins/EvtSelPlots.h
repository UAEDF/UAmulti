...
class EvtSelPlots : public TObject {
  ...
  public :
    ...
    TH1F* nch_vtxSel;
    TH1F* nch_L1_hfSel;
    TH1F* nch_L1_hf_vtxSel;
    TH1F* nch_L1_b40_vtxSel;
    TH1F* nch_denom;
    TH1F* pt_denom;
    TH1F* eta_denom;
    ...
    TH2F* vtxqual_L1_hf_vtxSel;
    TH2F* vtxqual_L1_b40_vtxSel;
    ...
    TrackPlots* trp_L1_hf_vtxSel;
    TrackPlots* trp_L1_b40_vtxSel;
    ...
    VertexPlots* vtxp_L1_hf_vtxSel;
    VertexPlots* vtxp_L1_b40_vtxSel;
    
    void init();
    void setSelBits(bool, bool, bool, bool);
  ...
  private:
    bool passL1, passHF, passVtx, passBit40;
