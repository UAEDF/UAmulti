...
void mptplotmc(double energy = 0.9, int iSaveFig = 0, float npx = 1000 , float npy = 600){
  ...
  if ( globalEnergy == 0.9 ) {
    ...
    dataSetFile.push_back("../plots/mptcorrv4/mptCorr_MC_D6T_0.9TeV_mbTr__dataType10.root");
    ...
    dataSetId.push_back(-1);
    dataSetFile.push_back("../plots/smallcodev4/smallCode_MCtype10_0.9TeV.root");
  ...
  if ( globalEnergy == 2.36) {
    ...
    dataSetId.push_back(-1);
    dataSetFile.push_back("../plots/mptcorrv4/mptCorr_MC_D6T_2.36TeV_mbTr__dataType10.root");
    dataSetIsMc.push_back(0);
    dataSetHType.push_back(1);
    dataSetStyle.push_back(kOpenCircle);
    dataSetColor.push_back(kBlack);
    ...
    dataSetId.push_back(-1);
    dataSetFile.push_back("../plots/smallcodev4/smallCode_MCtype10_2.36TeV.root");
    dataSetIsMc.push_back(1);
    dataSetHType.push_back(1);
    dataSetStyle.push_back(20);
    dataSetColor.push_back(kRed);
  ...
  if ( globalEnergy == 7.0) {
    ...
    dataSetId.push_back(-1);
    dataSetFile.push_back("../plots/mptcorrv4/mptCorr_MC_ATLAS_7.0TeV_mbTr__dataType31.root");
    dataSetIsMc.push_back(0);
    dataSetHType.push_back(1);
    dataSetStyle.push_back(kOpenCircle);
    dataSetColor.push_back(kBlack);
    ...
    dataSetId.push_back(-1);
    dataSetFile.push_back("../plots/smallcodev4/smallCode_MCtype31_7TeV.root");
    dataSetIsMc.push_back(1);
    dataSetHType.push_back(1);
    dataSetStyle.push_back(20);
